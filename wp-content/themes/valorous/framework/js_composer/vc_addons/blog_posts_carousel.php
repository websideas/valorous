    ...
    "params" => array(
        ...
        array(
            ...
            'value' => array(
                ...
                __( 'Circle Border', THEME_LANG ) => 'border_circle',
                __( 'Square Border', THEME_LANG ) => 'border_square',
                __( 'Round Border', THEME_LANG ) => 'border_round',
            ),
            'std' => 'circle_border',
            "dependency" => array("element" => "navigation","value" => array('true')),
        ),
        ...
        array(
            ...
            "suffix" => __("px", THEME_LANG),
            'group' => __( 'Carousel settings', THEME_LANG ),
            "dependency" => array("element" => "navigation_style","value" => array('border_circle', 'border_square', 'border_round')),
        ),
        array(
            'type' => 'colorpicker',
