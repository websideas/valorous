...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            ...
            'param_name' => 'color',
            'value' => array_merge( array( __( 'Default', 'js_composer' ) => 'default' ), getVcShared( 'colors' ),  array( __( 'Accent color', THEME_LANG ) => 'accent' ),array( __( 'Custom color', 'js_composer' ) => 'custom' ) ),
